...
static function array<X2DataTemplate> CreateTemplates()
{
	...
	Templates.AddItem(Avenger());
		Templates.AddItem(Avenger_Battlelord());
...
static function X2AbilityTemplate Avenger()
{
	...
	Template.AdditionalAbilities.AddItem('Avenger_Battlelord');
	Template.BuildNewGameStateFn = TypicalAbility_BuildGameState;

	return Template;
}

static function X2AbilityTemplate Avenger_Battlelord()
{
	local X2AbilityTemplate			Template;
	local X2AbilityCost_ActionPoints        ActionPointCost;
	local X2Effect_AvengerBattlelord			BattlelordEffect;


	`CREATE_X2ABILITY_TEMPLATE(Template, 'Avenger_Battlelord');
	...
	BattlelordEffect = new class'X2Effect_AvengerBattlelord';
